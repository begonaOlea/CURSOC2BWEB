...
@WebServlet(name = "SaludoServlet",
        ...
        loadOnStartup = 1,
        initParams = {
            @WebInitParam(name = "name", value = "Lucas"),
            @WebInitParam(name = "veces", value = "2")
        })
public class SaludoServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        System.out.println("..... SE HA INICIADO EL SERVLET ");
        
        String paramIni1 = config.getInitParameter("name");
        String paramIni2 = config.getInitParameter("veces");
        
        this.nombre = paramIni1;
